...
public class HeadHunterTest extends BaseTest {
    ...
    public void checkAttributesHushMap(){
        ...
        expectedAttributes.put(hhResumePage.Metro, "м. Бескудниково");
        expectedAttributes.put(hhResumePage.Email, "gazeevdina@gmail.com");
    ...
    public void checkAttributesClass(){
        ...
        Resume expectedAttributes = new Resume
                ("М", "Москва", 29, true,
                        true, "gazeevdina@gmail.com","м. Бескудниково");
        // Создаем экземпляр класса с актуальным результатом
        // HhResumePage это переменная
        Resume actualAttributes = new Resume
                (HhResumePage.getGender(),HhResumePage.getCity(),HhResumePage.getAge(),
                        ...
                        HhResumePage.getEmail(), HhResumePage.getMetro());
        // 1ЫЙ вариант сравнения классов
        Assert.assertTrue(EqualsBuilder.reflectionEquals(expectedAttributes,actualAttributes));
        // 2ой вариант сравнения классов
         ...
         Assert.assertEquals(expectedAttributes.getEmail(),actualAttributes.getEmail());
         Assert.assertEquals(expectedAttributes.getMetro(),actualAttributes.getMetro());
